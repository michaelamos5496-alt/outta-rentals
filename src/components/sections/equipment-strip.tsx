        ...
        <div className="scrollbar-none flex snap-x gap-2 overflow-x-auto py-4 sm:flex-wrap sm:justify-center sm:gap-3 sm:overflow-visible">
          {equipmentCategories.map((category) => (
            <Link
              ...
              className="group/chip flex shrink-0 snap-start items-center gap-2 border-2 border-foreground px-4 py-2 transition-colors hover:bg-brand-muted hover:text-brand"
            >
              <category.icon
