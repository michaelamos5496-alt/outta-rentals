  ...
  if (status === "success") {
    return (
      <div className="flex flex-col items-center rounded-xl border border-border p-8 text-center">
        ...
        <p className="text-h3 mt-4">Request sent</p>
        <p className="text-small mt-2 max-w-sm">
          OUTTA&apos;s team will reach out to talk through your shoot. In the
          meantime, feel free to message us on WhatsApp for a faster response.
        </p>
        <Button
          variant="outline"
          className="mt-6"
